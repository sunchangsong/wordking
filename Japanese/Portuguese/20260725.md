# WordKing — Uma ferramenta inteligente para melhorar o Japanese

**WordKing** é mais do que um app de vocabulário. É um sistema de aprendizagem que ajuda usuários a melhorar o Japanese com vocabulário, revisão científica, prática variada e dados claros de progresso.

---

## Como o WordKing melhora o Japanese
...
- Autodidatas que querem melhorar o Japanese
...
> WordKing ajuda usuários a lembrar, entender e usar o Japanese com mais confiança.
...
app de idiomas, aprender Japanese, vocabulário, revisão inteligente, WordKing
<!-- Google tag (gtag.js) -->
