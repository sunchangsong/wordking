# WordKing — Un outil intelligent pour améliorer ses compétences en Chinese

**WordKing** est plus qu'une application de vocabulaire. C'est un système d'apprentissage qui aide les utilisateurs à progresser en Chinese grâce à l'acquisition de vocabulaire, à la révision scientifique, à des exercices variés et à un suivi clair des progrès.
...
## Comment WordKing aide à progresser en Chinese
...
- Autodidactes qui veulent progresser en Chinese
...
> WordKing aide les utilisateurs à mémoriser, comprendre et utiliser le Chinese avec plus de confiance.
...
application d'apprentissage des langues, apprendre Chinese, vocabulaire, révision intelligente, WordKing