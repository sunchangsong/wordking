# WordKing — Uma ferramenta inteligente para melhorar o Chinese

**WordKing** é mais do que um app de vocabulário. É um sistema de aprendizagem que ajuda usuários a melhorar o Chinese com vocabulário, revisão científica, prática variada e dados claros de progresso.

---

## Como o WordKing melhora o Chinese
...
- Autodidatas que querem melhorar o Chinese
...
> WordKing ajuda usuários a lembrar, entender e usar o Chinese com mais confiança.
...
app de idiomas, aprender Chinese, vocabulário, revisão inteligente, WordKing
<!-- Google tag (gtag.js) -->
