# Como aprender Chinese com o WordKing

Aprender Chinese não é apenas memorizar palavras isoladas. O progresso real acontece quando pronúncia, vocabulário, frases, leitura, escuta e expressão são treinados juntos.
...
Baixe o **WordKing** e aprenda Chinese com um método mais sistemático.
...
aprender Chinese, vocabulário Chinese, aplicativo de idiomas, WordKing, revisão inteligente
<!-- Google tag (gtag.js) -->
