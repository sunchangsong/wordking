# WordKing — Uma ferramenta inteligente para melhorar o Portugues Brazil

**WordKing** é mais do que um app de vocabulário. É um sistema de aprendizagem que ajuda usuários a melhorar o Portugues Brazil com vocabulário, revisão científica, prática variada e dados claros de progresso.

---

## Como o WordKing melhora o Portugues Brazil
...
- Autodidatas que querem melhorar o Portugues Brazil
...
> WordKing ajuda usuários a lembrar, entender e usar o Portugues Brazil com mais confiança.
...
app de idiomas, aprender Portugues Brazil, vocabulário, revisão inteligente, WordKing
<!-- Google tag (gtag.js) -->
