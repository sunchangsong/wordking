# WordKing — Uma ferramenta inteligente para melhorar o French

**WordKing** é mais do que um app de vocabulário. É um sistema de aprendizagem que ajuda usuários a melhorar o French com vocabulário, revisão científica, prática variada e dados claros de progresso.

---

## Como o WordKing melhora o French
...
- Autodidatas que querem melhorar o French
...
> WordKing ajuda usuários a lembrar, entender e usar o French com mais confiança.
...
app de idiomas, aprender French, vocabulário, revisão inteligente, WordKing
<!-- Google tag (gtag.js) -->
