# WordKing — Uma ferramenta inteligente para melhorar o Korean

**WordKing** é mais do que um app de vocabulário. É um sistema de aprendizagem que ajuda usuários a melhorar o Korean com vocabulário, revisão científica, prática variada e dados claros de progresso.

---

## Como o WordKing melhora o Korean
...
- Autodidatas que querem melhorar o Korean
...
> WordKing ajuda usuários a lembrar, entender e usar o Korean com mais confiança.
...
app de idiomas, aprender Korean, vocabulário, revisão inteligente, WordKing
<!-- Google tag (gtag.js) -->
