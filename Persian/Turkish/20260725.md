# WordKing — Persian becerilerini geliştiren akıllı öğrenme aracı

**WordKing** yalnızca kelime ezberleme uygulaması değildir. Kelime gelişimi, bilimsel tekrar, farklı alıştırmalar ve net ilerleme verileriyle kullanıcıların Persian becerilerini güçlendiren bir öğrenme sistemidir.

---

## WordKing Persian öğrenimine nasıl yardımcı olur?
...
- Persian geliştirmek isteyen kendi kendine öğrenenler
...
> WordKing kullanıcıların Persian dilini hatırlamasına, anlamasına ve güvenle kullanmasına yardımcı olur.
...
dil öğrenme uygulaması, Persian öğrenme, kelime uygulaması, akıllı tekrar, WordKing